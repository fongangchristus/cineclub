(function() {
    ...
    function jhiAlertErrorController ($scope, toaster, AlertService, $rootScope, $translate) {
        var vm = this;
        ...
        var cleanHttpErrorListener = $rootScope.$on('pgwitgApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (angular.isString(errorHeader)) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('pgwitgApp.' + fieldError.objectName + '.' + convertedField);
                        addErrorAlert('Field ' + fieldName + ' cannot be empty', fieldError.message, {fieldName: fieldName});
